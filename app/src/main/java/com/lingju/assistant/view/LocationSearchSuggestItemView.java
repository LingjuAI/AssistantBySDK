 ...
 */
public class LocationSearchSuggestItemView extends LocationItemView {
    private final static String TAG="LocationFavoriteItemView";

    private ImageButton searchBt;

    public LocationSearchSuggestItemView(Context context, BaiduAddress address, String keyword) {
        super(context,address,keyword);
    }

    public LocationSearchSuggestItemView(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public LocationSearchSuggestItemView(Context context, AttributeSet attrs, int defStyle) {
