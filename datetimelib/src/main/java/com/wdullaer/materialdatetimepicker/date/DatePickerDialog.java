...
public class DatePickerDialog extends DialogFragment implements
    ...
    public void initialize(OnDateSetListener callBack, int year, int monthOfYear, int dayOfMonth) {
        ...
        mVersion = Version.VERSION_2;//Build.VERSION.SDK_INT < 23 ? Version.VERSION_1 : Version.VERSION_2;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (savedInstanceState != null) {
            ...
            mVersion = Version.VERSION_2;//(Version) savedInstanceState.getSerializable(KEY_VERSION);
            mTimezone = (TimeZone) savedInstanceState.getSerializable(KEY_TIMEZONE);
        }

        int viewRes = R.layout.mdtp_date_picker_dialog_v2;//mVersion == Version.VERSION_1 ? R.layout.mdtp_date_picker_dialog : R.layout.mdtp_date_picker_dialog_v2;
...
//        cancelButton.setTypeface(TypefaceHelper.get(activity,"Roboto-Medium"));
    ...
    public void setVersion(Version version) {
        mVersion = Version.VERSION_2;//version;
    }
