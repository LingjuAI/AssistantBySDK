...
-keep class com.lingju.robot.ChatRobotBuilder {
    public <methods>;
}
-keep class com.lingju.robot.ChatRobotBuilder$** {
    *;
...
-keep class com.lingju.robot.context.UserContext{*;}
-keep class com.lingju.robot.context.entity.** {*;}
-keep class  com.lingju.robot.extern.impl.** {*;}
...
-keep public enum  com.lingju.robot.context.ChatResult$** {
    **[] $VALUES;
    public <fields>;
    public <methods>;
}
-keep class com.lingju.robot.extern.** {
    <fields>;
    <methods>;
}
...
-keeppackagenames com.lingju.audio.**
...
-assumenosideeffects public class com.lingju.alice.extern.impl.Log {
...
-assumenosideeffects public class * extends java.lang.Throwable {
