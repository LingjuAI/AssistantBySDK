...
public final class AmrInputStream extends InputStream
{
    ...
    public final static int BYTES_PER_FRAME=SAMPLES_PER_FRAME * 2;
    //private final static int SAMPLES_PER_FRAME = 16000 * 20 / 1000;
    ...
    // result amr stream
    private final byte[] mBuf = new byte[BYTES_PER_FRAME];
